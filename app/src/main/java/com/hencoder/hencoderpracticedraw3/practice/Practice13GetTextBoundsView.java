...
public class Practice13GetTextBoundsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(text2, 200, middle+offset1, paint2);
        canvas.drawText(text3, 300, middle+offset1, paint2);
        canvas.drawText(text4, 400, middle+offset1, paint2);
        canvas.drawText(text5, 500, middle+offset1, paint2);
        canvas.drawText(text6, 600, middle+offset1, paint2);
